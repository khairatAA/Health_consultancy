...
let Patient = (() => {
    let _classDecorators = [(0, sequelize_typescript_1.Table)({ tableName: 'patients' })];
    ...
    var Patient = _classThis = class extends _classSuper {
        constructor() {
            super(...arguments);
            ...
            __runInitializers(this, _birthDate_extraInitializers);
        }
    };
    ...
    (() => {
        ...
        _birthDate_decorators = [(0, sequelize_typescript_1.Column)({
